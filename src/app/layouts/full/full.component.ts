...
export class FullComponent implements OnInit {
  ...
  company: {
    ...
    website?: string;
      ...
      name: environment.companny.name,
      slogan: environment.companny.slogan,
      description: environment.companny.description,
      phone: environment.companny.phone,
      website: environment.companny.website,
    };
